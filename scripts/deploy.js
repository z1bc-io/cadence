...
const fs = require('fs')
const project_config = require('../project_config.json')
...
async function main () {
  ...
  let contract_owner = project_config[hre.network.name]['contract_owner']['address']
  let envChain = project_config[hre.network.name]['chain']
