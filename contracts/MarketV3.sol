...
contract NFTMarketV3 is IAuctionHouse, Initializable, ReentrancyGuardUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  constructor() initializer {
    listingPrice = 0.500 ether;
  }

	function _authorizeUpgrade(address) internal override onlyOwner {
		version = "3.0"; // this will actually be called when upgrading the contract.
	}
